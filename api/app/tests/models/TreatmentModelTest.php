...
class TreatmentModelTest extends DatabaseTestCase 
{
    ...
    /**
     * Test case TC-01: Kiểm tra khởi tạo đối tượng TreatmentModel
     */
    public function testConstructor()
    {
        $this->logSection("TC-01: Kiểm tra khởi tạo đối tượng");
    ...
    {
        $this->logSection("TC-02: Kiểm tra select bằng ID");
    ...
    /**
     * Test case TC-03: Kiểm tra select với name
     */
    public function testSelectByName()
    {
        $this->logSection("TC-03: Kiểm tra select bằng name");
    ...
    /**
     * Test case TC-04: Kiểm tra giá trị mặc định
     */
    public function testExtendDefaults()
    {
        $this->logSection("TC-04: Kiểm tra giá trị mặc định");
    ...
    /**
     * Test case TC-05: Kiểm tra thêm mới phương pháp điều trị
     */
    public function testInsert()
    {
        $this->logSection("TC-05: Kiểm tra thêm mới phương pháp điều trị");
    ...
    /**
     * Test case TC-06: Kiểm tra cập nhật phương pháp điều trị
     */
    public function testUpdate()
    {
        $this->logSection("TC-06: Kiểm tra cập nhật phương pháp điều trị");
    ...
    /**
     * Test case TC-07: Kiểm tra xóa phương pháp điều trị
     */
    public function testDelete()
    {
        $this->logSection("TC-07: Kiểm tra xóa phương pháp điều trị");
    ...
    {
        $this->logSection("TC-08: Kiểm tra select với ID không tồn tại");
    ...
    /**
     * Test case TC-09: Kiểm tra select với name không tồn tại
     */
    public function testSelectWithNonExistingName()
    {
        $this->logSection("TC-09: Kiểm tra select với name không tồn tại");
